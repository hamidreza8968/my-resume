...
export default function Introduction({myInformation}) {
    ...
    return (
        <div>
            ...
            <ul className="list">
                <li className="list-item">I'm <span>{myInformation.age}</span> years old With <span>6</span> years of experience as a process management specialist, I've developed adaptable and collaborative skills.</li>
