...
const myInformation = {
  ...
  introduction: "I'm excited about the opportunity to discuss my journey into front-end development. I had graduated in master's degree in industrial management field and I use to be a employee in the very big insurance company in Iran as a process management specialist for 6 years. I always tried to use my highest ability in every job, even sales, and also to be committed and loyal to my company. although I was successful in this job and got promoted 2 times but I wasn't happy and satisfied actually. I have always been interested in programming and took some courses about it during my pervious job. also I know that the programming is very appropriate for my personality. after my marriage because of my wife's job (by the way she is a very talented frontend developer) I got to know more about this field and its benefits. Although my income was more than my wife's, I was always jealous of her job. because she could write some code and immediately check the result and I personally think it's very amazing in the job. So I have started to study and search about this field and after quiting my ex-job and moving to sweden I have spent the last Year honing my skills in web development and spend all last year for learning and practicing. I developed a strong foundation in HTML, CSS, and JavaScript, and I've been eager to apply these skills in a professional setting. I've completed a few personal projects that showcase my abilities, such as creating responsive websites and collaborating with others on GitHub. Additionally, I'm a quick learner and thrive in a dynamic, fast-paced environment. I've always been passionate about creating user-friendly and visually appealing web experiences, which is why I'm drawn to front-end development.I've been following the latest industry trends and best practices, and I'm excited about the potential to work with your team.",
...
function App() {
  ...
  return (
    <div className="App">
      <Header myInformation={myInformation}/>
    </div>
  );
}
